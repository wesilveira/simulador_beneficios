...
<!-- End Google Tag Manager (noscript) -->
  ...
  <div class="modal" id="carrega-doc" style="display:inline">
      <div class="modal-dialog">
        <div class="modal-content" style="border: none;">
            <div class="modal-header" style="background: #fff;border-radius: 30px;border: 2px;border-color: rgba(0,123,255,.25);">
            <center>
            ...
            <div class="modal-body">
              <br>
            <P class="loading-text">Aguarde enquanto carregamos os dados e preparamos a sua proposta digital.</P> 
            </div>
        </div>
      </div>
    </div>
                                    ...
                                    <!-- <div class="card-header" id="headingOne">
                                      ...
                                      <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                        <!--<div class="card-body">-->
                                          ...
                                          <p class="texto11-left">PARABÉNS!</p>  
                                          <p class="texto1-central" style="text-align: justify; text-justify: inter-word;">Agora que finalizou o processo de venda, agradeça o cliente e finalize a ligação.</p>
                                          ...
                                          <p class="texto1-central" style="text-align: justify; text-justify: inter-word;">1º Oriente o cliente à leitura do contrato. Caso ele opte em ter mais tempo, ligue para ele novamente em horário combinado;</p>
                                          <p class="texto1-central" style="text-align: justify; text-justify: inter-word;">2º Ele precisa assinar o documento, e em seguida, inserir o tolken. Caso contrário a proposta não estará válida;</p>
                                          <p class="texto1-central" style="text-align: justify; text-justify: inter-word;">3º Depois da confirmação da assinatura, informe-o que os todos os dados serão avaliados por nossa equipe de implantação e entrará em contato caso a proposta esteja aprovada ou negada.</p>
                                          <p class="texto1-central" style="text-align: justify; text-justify: inter-word;">4º Informe-o também que esse tempo médio é de até 3 dias úteis;</p>
                                          <p class="texto1-central" style="text-align: justify; text-justify: inter-word;">5º Informe que a vigência do plano ocorre na data estipulada no contrato;</p>
                                          </div>
