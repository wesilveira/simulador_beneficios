        ...
        <div class="area-principal">
              <div class="bar-left">
                  <div class="card mt-3 mb-3" style="padding: 20px">
                      <form id="msform">  
                            <p class="texto1-left msgIncDep">Se desejar incluir dependentes, insira a <strong>data de nascimento</strong> e clique em incluir. Você pode incluir até 5 dependentes.</p>
                            <br><br>
                            <p class="texto1"><strong>Resumo do Plano Escolhido:</strong></p>
                              <fieldset>	
                                <div class="form-card" id="planos2">
                                  ...
                                  <br>
                                  <p class="texto1"></p>
                                  <p class="texto1-left-dep"><strong>1</strong> Titular + <strong><span class="qtDept">0</span> </strong>Beneficiário(s).</p>
                                  <p class="texto1"></p>
                                </div> 
                                <!--<input type="button" id="btnE13" name="next" class="next action-button" value="Avançar" disabled>-->
                              </fieldset>
                      </form>
                  </div>
              </div>
                  ...
                  <div class="container-central" style="margin-top: 0;margin-left: 0;width: 100%;">
                            <div class="incluirBeneficiario" style="width: 70%;margin-left: 20px;">                  
                                        ...
                                        <form id="msform">
                                                    ...
                                                    <div>                                                        
                                                        <div class="inner">
                                                        <p class="texto"><strong>INCLUIR BENEFICIÁRIOS</strong></p>
                                                        <p class="texto0-central">Você sabia que pode incluir outros beneficiários a este plano de assistência?</p>
                                                        <p class="texto0-central">Você pode adicionar até 5 beneficiários.</p>
                                                        <br>
                                                    ...
                                                    <div class="form-card-dep" id="planos2">
                                                      ...
                                                      <p class="texto1-central"><strong>1</strong> Titular + <strong><span class="qtDep">0</span> </strong>Beneficiário(s).</p>
                                                      <p class="texto1-central"></p>                                    
                                                      
                                                    </p>
                                                    </div> 
                                                        <input style="display:none; !IMPORTANT" type="button" name="next" id="btnSemDependente" class="next action-button" value="Avançar sem dependentes">
                                                        
                                                        <input type="button" name="next" id="btnEncerraAddDepFamilia"  class="next action-button" value="Resumo dos Planos">
                                                        <input type="button" style="background: #006da8;display:none" name="next" id="btnOrcamento"  class="next action-button" value="Orçamento">
