        ...
        <div style="background-color:#ffffff; background-image: linear-gradient(#ffffff, #cdedff, #a2cee8, #00639b);">
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <table border="0">
                        <tr>
                            <td width="35%" valign="top" style="padding:100px;"><img src="assets_new/images/medico-1.png" height="600" width="400"></td>
                            <td width="65%" height="1000" valign="top" style="padding:100px;">
                            
                            
                            
                            <div class="container-fluid"> 
                <p class="texto11"><strong>IMPORTANTE!</strong></p>
                <p class="texto1" style="text-align: justify; text-justify: inter-word;"><strong class="nomeTit">João</strong>, enviamos a sua FICHA DE ASSOCIAÇÃO para o e-mail que você cadastrou. Agora é só você assinar digitalmente, e pronto! </p>
                <p class="texto1" style="text-align: justify; text-justify: inter-word;">Acesse AGORA sua caixa de e-mails, assine digitalmente sua ficha e volte  
nesta tela para continuar o processo. </p>  
                <p class="texto1" style="text-align: justify; text-justify: inter-word;"><strong>ATENÇÃO:</strong> Só podemos continuar após a sua assinatura digital na ficha associativa. 
Verifique sua caixa de e-mail. Caso ela não esteja lá, verifique também na sua caixa de spam. 
Se a ficha não chegar em alguns minutos, entre em contato.</p>
            </div>
          ...
          <div>
            ...
            <div class="row justify-content-center">
              ...
              <div class="col-11 col-sm-9 col-md-7 col-lg-6 col-xl-11 text-center p-0 mt-3 mb-2">
                  <div>
                      <p class="texto"><strong>Associação Entidade</strong></p>
                      <form id="msform">
                          ...
                          <p class="texto1"><strong>Resumo do Plano Escolhido:</strong></p>
                                <fieldset>	
                                  ...
                                  <input type="button" id="btnE7" name="next" class="next action-button" value="Continuar">
