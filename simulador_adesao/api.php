<?php
  ...
  if(isset($params["frmType"]))
  {
    ...
    switch($tipo){
      ...
      case "gravaLead":
        $payload = null;
        //TRATAMENTO INICIAL DE RECEBIMENTO DOS DADOS
        ...
        //PROCESSO DE GERAÇÃO DO OBJETO LEAD
        $lead = new Lead($payload["NAME"],$payload["NAME"],$payload["PHONE"],$payload["EMAIL"],$comment,$payload["CODIGO"],$payload["CODIGO"],"STORE",$payload["UTM_SOURCE"],$payload["UTM_MEDIUM"],$payload["UTM_CAMPAIGN"],$payload["UTM_CONTENT"],$payload["UTM_TERM"],$payload["OPERACAO"]);
        //CRIAÇÃO DO LEAD NO CRM
        $lead_id = $lead->geraLead();
        
        //VALIDAÇÃO DA CRIAÇÃO DO LEAD NO CRM
        if(isset($lead_id) and ($lead_id != "" or !empty($lead_id)))
        {
          header('Content-Type: application/json');
      ...
      case "buscaPlanoDep":
        ...
        exit;
        break;
      case "buscaPlanoOdonto":
          if(isset($_POST["plano_escolhido"])){
            $catalog_id = null;
           // $idade = $_POST["idade"];
            $plano = json_decode($_POST["plano_escolhido"],true);
            if($_POST["uf"] == "RN")
      ...
      case "buscaPlanos":
        ...
        if(isset($_POST["payload"]))
        {
          ...
          $buscaOperadoras = mysqli_query($conexao,"select * from operadoras where tipo_tabela = 'A' and tipo_produto = 'beneficio'");
          ...
          //montagem html planos
            ...
            foreach ($resultPlanos as $plano) {
              ...
              $operadoras_entidade_aberta = ["4152"];
              ...
              {
                $html_planos .= '
                <div class="gallery_product  col-sm-6 col-xs-6 filter acomoda'.$plano["PROPERTY_100"]["value"].' copart'.$plano["PROPERTY_104"]["value"].' " data-order="'.$line.'" data-price="'.$plano["PRICE"].'" data-operadoraid="'.$operadoraID.'">
                <div class="container_plan" >
                  <table class="borda_plano">
                        ...
                        <td>
                            <div style="width: 80%;margin-left: 10%">
                              <table style="width: 100%">
                                  <tr>
                                      <td class="titulo_plano"><strong>'.$plano["NAME"].'</strong></td>
                                  </tr>
                                  <tr>
                                      <td class="titulo_plano"><strong>COD.:</strong> '.$plano["PROPERTY_130"]["value"].'</td>
                                  </tr>
                              </table>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td colspan="2" class="borda_plano_inter">
                            <table class="borda_plano_inter2">
                                ...
                                <tr>
                                    <td class="texto4">&nbsp;'.$plano["PROPERTY_150"]["value"]["TEXT"].'</td>
                                </tr>
                                <tr>
                                    <td height="10"></td>
                                </tr>
                    ...
                    <tr>  
                        ...
                        <input type="button" name="info" class="btn filter-button2 infoPlan" id="informacoes" value="INFORMAÇÕES" data-plano=\''.json_encode($plano).'\' style="width: 80%;"><br><br>                        
                        </td>
                    </tr>
      ...
      case "gravaDadosDep":
        if(isset($_POST["deal_id"]) and $_POST["deal_id"] != "" and $_POST["payload"] != "")
        {
          ...
          if(isset($dependentes[1])){
            ...
            ';
            if($dependentes[1]["odonto"] === "sim"){
              $fields .= ',"UF_CRM_5FFF36B93CEA1": "4244"';
            }else{
              $fields .= ',"UF_CRM_5FFF36B93CEA1": "4246"';
            }
          ...
          if(isset($dependentes[2])){
            ...
            if($dependentes[2]["odonto"] === "sim"){
              $fields .= ',"UF_CRM_1611068261": "4270"';
            }else{
              $fields .= ',"UF_CRM_1611068261": "4272"';
            }
          ...
          if(isset($dependentes[3])){
            ...
            if($dependentes[3]["odonto"] === "sim"){
              $fields .= ',"UF_CRM_1611068283": "4274"';
            }else{
              $fields .= ',"UF_CRM_1611068283": "4276"';
            }
          }
          ...
          if(isset($dependentes[4])){
            ...
            if($dependentes[4]["odonto"] === "sim"){
              $fields .= ',"UF_CRM_1611068388": "4278"';
            }else{
              $fields .= ',"UF_CRM_1611068388": "4280"';
            }
          ...
          if(isset($dependentes[5])){
            ...
            if($dependentes[5]["odonto"] === "sim"){
              $fields .= ',"UF_CRM_1611068404": "4282"';
            }else{
              $fields .= ',"UF_CRM_1611068404": "4284"';
            }
          }
      ...
      case "converteLead":
        ...
        //Configura campo de odonto como sim ou não;
        if(isset($odonto["id_plano"])){
          $possuiOdonto = '4266';
        }else{
          $possuiOdonto = '4268';
        }
        ...
        $payloadContato = '{
            "fields": {
                ...
                "UF_CRM_1611067775": "'.$possuiOdonto.'",
                "PHONE": [
                    {
                        "VALUE": "'.$payload["PHONE"].'",
                        "VALUE_TYPE": "WORK"
        ...
        if(isset($criaContato["result"]) and ($criaContato["result"] != "" or !empty($criaContato["result"])))
        {
          ...
          if(isset($updDeal["result"]))
          {
            ...
            if(isset($odonto["id_plano"])){
              $payloadProdDep .= '
                ,{
                    "PRODUCT_ID": "'.$odonto["id_plano"].'",
                    "PRICE": "'.$odonto["price_plano"].'",
                    "QUANTITY": 1
                }
                ';
            }else{
