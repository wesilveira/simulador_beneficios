...
$(document).ready(function() {
    ...
    if (localStorage.getItem("currentPage") === "2") {
        ...
        $("#planosToShow").on("click", ".choosePlan", function(e) {
            ...
            $(".ansPlan").text(plano.PROPERTY_130.value);
        ...
        $("#planosToShow").on("click", ".infoPlan", function(e) {
            var plano = JSON.parse($(this).attr("data-plano"));
            ...
            $(".ansPlan").text(plano.PROPERTY_130.value);
            $(".picture-plan").attr("src", plano.imgSrc);
            if(plano.PROPERTY_134 !== null){
                $("#funeral").show();
                var element = document.getElementById('assFuneral');
                element.innerHTML = plano.PROPERTY_134.value.TEXT;

            }else{
                $("#funeral").hide();
            }
            if(plano.PROPERTY_142 !== null){
                $("#pet").show();
                var element = document.getElementById('assPet');
                element.innerHTML = plano.PROPERTY_142.value.TEXT;

            }else{
                $("#pet").hide();
            }
            if(plano.PROPERTY_138 !== null){
                $("#residencial").show();
                var element = document.getElementById('assResidencial');
                element.innerHTML = plano.PROPERTY_138.value.TEXT;
            }else{
                $("#residencial").hide();
            }
            if(plano.PROPERTY_148 !== null){
                $("#descontos").show();
                var element = document.getElementById('clubeDesconto');
                element.innerHTML = plano.PROPERTY_148.value.TEXT;
            }else{
                $("#descontos").hide();;
            }
            if(plano.PROPERTY_140 !== null){
                $("#farmacias").show();
                var element = document.getElementById('descFarmacia');
                element.innerHTML = plano.PROPERTY_140.value.TEXT;
            }else{
                $("#farmacias").hide();
            }
        ...
        $("#btnConfOdonto").click(function(){
            $.confirm({
                ...
                content: "" +
                    ...
                    '<br><br>'+
                    '<input type="text" placeholder="Nome Beneficiário" class="nameDepAdd form-control" required />' +
                    "<label>Informe o nome do beneficiário</label>" +
                    "</div>" +
                    '<br><br>'+
                    '<div class="form-group">' +
                    '<p class="texto0-central" style="font-size: 20px;color: #f27e2c;">Gostaria de adicionar odontologia para esse beneficiário?</p>'+
                    '<br><br>'+
                    '<div style="margin-left:25%;margin-right: 25%">'+
                    '    <button class="btn btn-primary addodonto" id="addodonto" onclick="localStorage.setItem(\'odonto'+(qtdep+1)+'\', \'sim\');" type="button">Sim</button>'+
                    '    <button class="btn btn-primary addodonto" id="addodonto" onclick="localStorage.setItem(\'odonto'+(qtdep+1)+'\', \'nao\')" type="button">Não</button>'+
                    '</div>'+
                ...
                buttons: {
                    formSubmit: {
                        ...
                        action: function() {
                            ...
                            if(plano.PROPERTY_132.value === "232"){
                            ...
                            if(plano.PROPERTY_132.value === "232"){
                                window.location.href = "4_incluir_odonto.php";
                            }else{
        ...
        $("#btnE2").click(function() {
            ...
            if(plano.PROPERTY_132.value === "232"){
                plano.tipo="individual";
                $.confirm({
                    title: "INCLUSÃO DE ODONTOLOGIA TITULAR",
                    theme: "modern",
                    content: "" +
                        '<form action="" class="formNameK">' +
                        '<br>'+
                        '<div class="form-group">' +
                        '<p class="texto0-central" style="font-size: 20px;color: #f27e2c;">Gostaria de contratar nosso plano assistência?</p>'+
                        '<br><br>'+
                        '<div style="margin-left:25%;margin-right: 25%">'+
                        '    <button class="btn btn-primary addodonto" id="addodonto" onclick="localStorage.setItem(\'odontoTitular\', \'sim\');" type="button">Sim</button>'+
                        '    <button class="btn btn-primary addodonto" id="addodonto" onclick="localStorage.setItem(\'odontoTitular\', \'nao\')" type="button">Não</button>'+
                        '</div>'+
            ...
            }else if(plano.PROPERTY_132.value === "234"){
                plano.tipo="familiar";
                $.confirm({
                    title: "INCLUSÃO DE ODONTOLOGIA TITULAR",
                    theme: "modern",
                    content: "" +
                        ...
                        '<br>'+
                        '<div class="form-group">' +
                        '<p class="texto0-central" style="font-size: 20px;color: #f27e2c;">Gostaria de adicionar plano odontológico para o titular do benefício?</p>'+
                        '<br><br>'+
                        '<div style="margin-left:25%;margin-right: 25%">'+
                        '    <button class="btn btn-primary addodonto" id="addodonto" onclick="localStorage.setItem(\'odontoTitular\', \'sim\');" type="button">Sim</button>'+
                        '    <button class="btn btn-primary addodonto" id="addodonto" onclick="localStorage.setItem(\'odontoTitular\', \'nao\')" type="button">Não</button>'+
            ...
            }else if(plano.PROPERTY_132.value === "258"){
                plano.tipo="Individual Odonto";
                $.confirm({
                    ...
                    content: "" +
                        ...
                        '<br>'+
                        '<div class="form-group">' +
                        '<p class="texto0-central" style="font-size: 20px;color: #f27e2c;">Gostaria de adicionar dependentes a este plano?</p>'+
                        '<br><br>'+
                        '<div style="margin-left:25%;margin-right: 25%">'+
                        '    <button class="btn btn-primary addodonto" id="addodonto" onclick="localStorage.setItem(\'odontoDep\', \'sim\');" type="button">Sim</button>'+
                        '    <button class="btn btn-primary addodonto" id="addodonto" onclick="localStorage.setItem(\'odontoDep\', \'nao\')" type="button">Não</button>'+
                        '</div>'+
                    ...
                    buttons: {
                        formSubmit: {
                            ...
                            action: function() {
                                ...
                                localStorage.setItem("currentStep", "4");
                                localStorage.removeItem("plano");
                                var temdependente = localStorage.getItem("odontoDep");
                                localStorage.removeItem("odontoDep");
    ...
    if (localStorage.getItem("currentPage") === "4") {
        ...
        if(orcamento === true){
            console.log("Iniciou carregamento de orçamento");
            carregaPlanoOrçamento();
        }else{
            console.log("Iniciou 4 etapa");
            carregaPlano();
        }

        function carregaPlano() {
            localStorage.setItem("qtDep","0");
            localStorage.setItem("qtOdonto","0");
            var infoCustomer = JSON.parse(localStorage.getItem("infoCustomer"));
            var orcamento = JSON.parse(localStorage.getItem("orcamento"));
            ...
            if(plano.PROPERTY_132.value === "232"){
                encerraAddOdontoIndividual();
            }else if(plano.PROPERTY_132.value === "234"){
                carregaInfoPlanoFamilia();
            }else if(plano.PROPERTY_132.value === "258"){
                carregaInfoPlanoOdonto();
            }else{
                encerraAddOdontoIndividual();
            }
        }

        function carregaPlanoOrçamento() {
            console.log("chamou CarregaOrçamento")
            var infoCustomer = JSON.parse(localStorage.getItem("infoCustomer"));
            var plano = infoCustomer.PLANO_ESCOLHIDO;
            $(".nomePlan").text(plano.NAME);
            $(".somaPlanos").text(plano.PRICE);
        ...
        $('.form-check-inline').on("change","input[type=checkbox]",function(){
            console.log("entrou");
            var radio_escolhido = $(this).attr("name").split('_');
            var nome_radio="lb_"+$(this).attr("name")+"_nao";
            if(this.checked){
                $(this).val('sim');
                document.getElementById(nome_radio).innerHTML= "  Sim";
                console.log($(nome_radio).val());
            }else{
                $(this).val('nao');
                document.getElementById(nome_radio).innerHTML= "  Não";
            }
        ...
        $("#btnAddDep").click(function() {
            ...
            function doAddDep(nome) {
                if (dataToAdd != "") {
                    var odonto = 'odonto'+(qtdep+1);
                    var optOdonto=localStorage.getItem(odonto);
                    ...
                    var elem =
                        ...
                        optOdonto +
                        '</td>'+
                        '<td><img width="24" class="delDep" src="assets/img/b_drop.png" /></td>\
                    ...
                    <input type="hidden" name="nome_dep[]" value="' +
                        nome +
                        '" />\
                    <input type="hidden" name="opcao_odonto[]" value="' +
                        optOdonto +
                        '" />\
                      </tr>';
        ...
        function encerraAddOdontoIndividual() {
            $("#loading").show();

            setTimeout(() => {
                var infoCustomer = JSON.parse(localStorage.getItem("infoCustomer"));
                var odontoTitular = localStorage.getItem("odontoTitular");
                var plano = infoCustomer.PLANO_ESCOLHIDO;
                var qtOdonto = localStorage.getItem("qtOdonto");
                var resumoPlanoTitular="";
                var resumoPlano = "";
                var somaPlanos = parseFloat(plano.PRICE);
                if(odontoTitular ==='sim'){
                    var data = new FormData();
                    data.append("frmType", "buscaPlanoOdonto");
                    data.append("uf", infoCustomer.UF_CRM_1582805357);
                    data.append("plano_escolhido", JSON.stringify(plano));
                    $.ajax({
                        type: "POST",
                        ...
                        success: function(result) {
                            if (result.error === "false") {
                                infoCustomer.odonto = new Object();
                                infoCustomer.odonto.id_plano = result.plano.ID;
                                infoCustomer.odonto.price_plano = result.plano.PRICE;

                                resumoPlanoTitular += `<span data-dep="titular1" style="font-size: 16px;">Titular com odontologia:<p class="texto0-central-plan" style="font-size: 18px;"> R$ ${new Intl.NumberFormat(
                                "de-DE",
                                {
                                    currency: "EUR",
                                ...
                                parseFloat(result.plano.PRICE).toFixed(2)
                                )}  </p></span><br>`;
                    ...
                    resumoPlanoTitular += `<span data-dep="titular1" style="font-size: 16px;">Titular sem odontologia</span><br><br>`;
                }
                var tipoAssit = "";

                if(plano.PROPERTY_132.value === "232"){
                    tipoAssit = "INDIVIDUAL";
                ...
                var resumoPlano = `
                                <p class="texto0-central-sub"><strong>PLANO ASSISTENCIAL ${tipoAssit}</strong></p>
                                <p class="texto0-central-plan">R$ ${new Intl.NumberFormat("de-DE", {
                                currency: "EUR",
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                ...
                $(".qtOdonto").text(qtOdonto);
                $(".qtOdontot").text(qtOdonto);

                infoCustomer.SUBTOTAL = somaPlanos;
                $(".somaPlanos").text(
                    "" +
                    new Intl.NumberFormat("de-DE", { currency: "EUR", minimumFractionDigits: 2, maximumFractionDigits: 2 }).format(
                        somaPlanos
                    )
                );
        ...
        function carregaInfoPlanoFamilia(){
            setTimeout(() => {
                var infoCustomer = JSON.parse(localStorage.getItem("infoCustomer"));
                var odontoTitular = localStorage.getItem("odontoTitular");
                var plano = infoCustomer.PLANO_ESCOLHIDO;
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            if (result.error === "false") {
                                ...
                                somaPlanos += parseFloat(result.plano.PRICE);
                                console.log(somaPlanos);
                                console.log(resumoPlano);
                ...
                var resumoPlano = `
                                <p class="texto0-central-sub"><strong>PLANO ASSISTENCIAL FAMILIAR</strong></p>
                                <p class="texto0-central-plan">R$ ${new Intl.NumberFormat("de-DE", {
                                currency: "EUR",
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                                ...
                                <div class="resumo_titular"></div>
                                <br>
                                <p class="texto0-central-sub"><strong>BENEFICIÁRIOS PLANO FAMILIAR</strong></p>
                                `;
                ...
                $('input[name^="data_nasc[]"]').each(function() {
                    var dataNasc = $(this).val();
                    var opcaoOdonto = $(this)
                         .closest("tr")
                         .find('input[name^="opcao_odonto[]"]')
                         .val();
                    ...
                    var nomeDep = $(this)
                     ...
                     console.log("dados do dependente")
                     console.log(nomeDep);
                    ...
                    dependente.nome = nomeDep;
                    dependente.data_nasc = dataNasc;
                    dependente.id_plano = null;
                    dependente.price_plano = null;
                    dependente.odonto = opcaoOdonto;

                    resumoPlano += `<hr/><span data-dep="${dep_i}" >BENEFICIÁRIO ${dep_i} <i style="color:#006da8" class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" title="${nomeDep}"></i>:<p class="texto0-central-plan" style="font-size: 21px;color:#006da8">${nomeDep}<img width="20" class="delDepAdded pointer" data-dep="${dep_i}" data-depNome="${nomeDep}" src="assets/img/b_drop.png" /></p></span><br>`;


                    //montagem de beneficiários com plano odontologia
                    //###############################################
                    if(dependente.odonto ==='sim'){
                        var data = new FormData();
                        data.append("frmType", "buscaPlanoOdonto");
                        data.append("uf", infoCustomer.UF_CRM_1582805357);
                        data.append("plano_escolhido", JSON.stringify(plano));
                        $.ajax({
                            ...
                            success: function(result) {
                                if (result.error === "false") {
                                    ...
                                    resumoPlano += `<span data-dep="${dep_i}" style="font-size: 16px;">Com odontologia:<p class="texto0-central-plan" style="font-size: 18px;"> R$ ${new Intl.NumberFormat(
                                    "de-DE",
                                    {
                                        currency: "EUR",
                                        minimumFractionDigits: 2,
                        ...
                        resumoPlano += `<span data-dep="${dep_i}" style="font-size: 16px;">Sem odontologia</span><br><br>`;
                    }
                    infoCustomer.dependentes[dep_i] = dependente;
        ...
        function carregaInfoPlanoOdonto(){
            setTimeout(() => {
                var infoCustomer = JSON.parse(localStorage.getItem("infoCustomer"));
                var odontoTitular = localStorage.getItem("odontoTitular");
                var plano = infoCustomer.PLANO_ESCOLHIDO;
                ...
                var resumoPlano = `
                                <p class="texto0-central-sub"><strong>PLANO ODONTOLÓGICO</strong></p>
                                <p class="texto0-central-plan">R$ ${new Intl.NumberFormat("de-DE", {
                                currency: "EUR",
                                minimumFractionDigits: 2,
                                maximumFractionDigits: 2
                                ...
                                <div class="resumo_titular"></div>
                                <br>
                                <p class="texto0-central-sub"><strong>BENEFICIÁRIOS PLANO ODONTOLÓGICO</strong></p>
                                `;
        ...
        function carregaOrcamentoPlanoFamilia(){
            setTimeout(() => {
                var infoCustomer = JSON.parse(localStorage.getItem("infoCustomer"));
                var odontoTitular = localStorage.getItem("odontoTitular");
                var plano = infoCustomer.PLANO_ESCOLHIDO;
                var odonto = infoCustomer.odonto;
                ...
                if(odontoTitular ==='sim'){
                                ...
                                parseFloat(odonto.price_plano).toFixed(2)
                                )}  </p></span><br>`;

                                somaPlanos += parseFloat(odonto.price_plano);
                ...
                while(dependentes[i]){
                    // var dataNasc = $(this).val();
                    var nomeDep = infoCustomer.dependentes[i].nome;
                    console.log("dados do dependente orçamento")
                    console.log(nomeDep);
                    var dependente = infoCustomer.dependentes[i];
                    ...
                    if(dependente.odonto ==='sim'){
                            ...
                            parseFloat(dependente.price_plano).toFixed(2)
                            )}  <img width="20" class="delDepAdded pointer" data-dep="${dep_i}" data-depNome="${nomeDep}" src="assets/img/b_drop.png" /></p></span><br>`;
        ...
        function carregaOrcamentoPlanoOdonto(){
            setTimeout(() => {
                var infoCustomer = JSON.parse(localStorage.getItem("infoCustomer"));
                var odontoTitular = localStorage.getItem("odontoTitular");
                var plano = infoCustomer.PLANO_ESCOLHIDO;
        ...
        function encerraAddOdontoFamilia() {
            $("#loading").show();
            var infoCustomer = JSON.parse(localStorage.getItem("infoCustomer"));
            var plano = infoCustomer.PLANO_ESCOLHIDO;

            if(plano.PROPERTY_132.value === "258"){
                carregaInfoPlanoOdonto();
            }else{
                carregaInfoPlanoFamilia();
            }
        ...
        function carregaOrcamento() {
            ...
            setTimeout(() => {
               ...
               if(plano.PROPERTY_132.value === "232"){
                    ...
                    carregaOrcamentoPlanoOdonto();
                }else{
                    //carregaInfoPlanoFamilia();
                    carregaOrcamentoPlanoFamilia();
                }
        ...
        $("#btnEncerraAddDepFamilia").click(function() {
            $.confirm({
                title: "Confirmação.",
                theme: "modern",
                content: "Tem certeza?",
        ...
        $(".addodonto").click(function() {
            var infoCustomer = JSON.parse(localStorage.getItem("infoCustomer"));
            var plano = infoCustomer.PLANO_ESCOLHIDO;

            var qntdOdonto = parseFloat(localStorage.getItem("qntdOdonto"));
            var valorOdonto = parseFloat($(".valorOdonto").text());
            var valorPlano = parseFloat(plano.PRICE);


            var total = parseFloat(valorPlano.toFixed(2)) + (parseFloat(valorOdonto.toFixed(2)) * qntdOdonto);

            $(".qtDep").text(qntdOdonto);
            $(".qtDept").text(qntdOdonto);
            $(".somaPlanos").text(total.toFixed(2));
    ...
    if (localStorage.getItem("currentPage") === "9") {
        ...
        if (localStorage.getItem("dataDep") === null && qtDep > 0) {
         ...
         //true, se necessário fase de coleta de documento
         var recebeDocumentacao = true;
         console.log(recebeDocumentacao);
         if(recebeDocumentacao) {
            //avança regras de automação
            var data = new FormData();
