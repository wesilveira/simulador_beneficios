<?php
  ...
  if(isset($_GET["doLogin"]))
  {
    ...
    $buscaLogin = mysqli_query($conexao,"select * from consultores where login = '$cpf_login' and password = '$encoded_password'");
...
<body>
    ...
    <header class="header-area">
      <div class="container col-4" style="padding-top: 150px;">
          <img class="imgLogin" src="assets/img/logo_parceiro.png" alt="Logo" style="width: 80%;">                                            <br>
          <div class="divLogin">
          <p class="texto"><strong>SIMULADOR DE BENEFÍCIOS</strong></p>
          <form id="msform" method="post" action="?doLogin">
            <fieldset>
            <div class="inner-login" align="left">
                <div class="form-row">
                <div class="form-group col-md-12">
                    <!--<label class="texto1-central" for="txtLogin">Código da Operação</label>-->
                    <input type="text" class="form-control-login" id="login" name="login" placeholder="CÓDIGO DA OPERAÇÃO" required>
                </div>
                </div>
                <div class="form-row">
                <div class="form-group col-md-12">
                    <!--<label class="texto1-central" for="txtPassword">Senha</label>-->
                    <input type="password" class="form-control-login" id="txtPassword" name="txtPassword" placeholder="SENHA" required>
                </div>
                </div>
            </div>
            <!--<p class="texto1-central" style="text-align:center;"><a href="esqueceu_senha.php">Esqueceu sua senha? Clique aqui.</a></p>-->
            <input type="submit" name="next" id="btnLogin" class="next action-button" value="ACESSAR" style="width: 100%">
            </fieldset>
          </form>
          </div>
      </div>
