        ...
        <div style="background-color:#ffffff; background-image: linear-gradient(#ffffff, #cdedff, #a2cee8, #00639b);">
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <table border="0">
                        <tr>
                            <td width="30%" valign="top" style="padding-top:100px;"><img src="assets_new/images/medico-1.png" height="600" width="400"></td>
      ...
      <div class="container">
            <div class="row">
                <div class="corpo_resumo">
                    <div class="container height-container" style="width: 100%; overflow-x:hidden;">
          ...
          <div>
            ...
            <div class="row justify-content-center">
              ...
              <!--<div class="col-11 col-sm-9 col-md-7 col-lg-6 col-xl-11 text-center p-0 mt-3 mb-2">-->
                  <div class="card mt-3 mb-3" style="background-color: #e6f1f7;padding: 20px">
                        <form id="msform">
                                                   
                          <p class="texto1">Clique a cima para gerar o rascunho da sua proposta. Leia com calma e atenção e ao final confirme se aprova ou não nossa negociação. Caso aprovado, vamos gerar a versão final da proposta.</p>
                          ...
                          <fieldset>	
                            ...
                            <input type="button" id="btnE13" name="next" class="next action-button" value="Rascunho Aprovado" disabled>
