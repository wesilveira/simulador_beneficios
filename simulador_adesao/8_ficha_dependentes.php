                        ...
                        <tr>
                            ...
                            <form id="frmFichaDep" style="width: 900px;margin-left: 20px;">
                              <div class="container-fluid">
                                  ...
                                  <p class="texto1-central"><strong>Beneficiário <span class="depAtual"></span></strong></p>
                                  ...
                                  <div class="form-row">
                                      ...
                                      <input type="date" class="form-control" id="dataNascDep" placeholder="Data nascimento dependente">
                                      </div>
                                  </div>                
                                  <div class="form-row">
                                      <div class="form-group col-md-12">
