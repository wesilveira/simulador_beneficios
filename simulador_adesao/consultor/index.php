      ...
      <div class="container">
        <div class="rowc">
          <div class="corpo2" style="width:100%">
            ...
            <div class="rowc justify-content-center">
            ...
            if($ds_enviada == "1")
              ...
              echo '<script>localStorage.setItem("infoCustomer",JSON.stringify('.json_encode($infoCustomer).'));</script>';
					  ...
					  //Dados proposta
					  $proposta_final = ($dadosProposta["keyid_proposta"] === NULL) ? "Contate atendimento." : curl_rest("https://app.clicksign.com/api/v1/documents/".$dadosProposta["keyid_proposta"]."?access_token=4f288e06-a179-4f4e-b4fe-7b64834fbf6f");
            $return_envio = null;
            $linkFatura=null;
            $botaoFatura=null;
            if($dadosProposta["keyid_proposta"] !== NULL)
              ...
              if(isset($link_external) and $link_external !== null)
              {
                ...
                if(!existeFaturaRecorrente($deal_id)){
                  ...
                  {
                    $linkFatura .= '<span style="color:green"><i class="fa fa-check" aria-hidden="true"></i>Recorrencia de fatura agendada em sistema</span>';
                  }else{
                    $linkFatura .='<span style="font-size: 11px;color:red">Faturas não foram agendadas no CRM/span>';  
                  }
                }else{
                  $linkFatura .= '<span style="color:green"><i class="fa fa-check" aria-hidden="true"></i>Recorrencia de fatura agendada em sistema</span>';
                } 
              ...
              $linkFatura ='<span style="font-size: 11px;color:red">Fatura não disponível no CRM</span>';
								...
								<div class="card">
								  ...
								  <ul class="list-group list-group-flush" style="font-size:12px">
									...
									<li class="list-group-item">
										...
										<hr />
										<strong>Plano Escolhido:</strong><br/> <?php echo $operadoras[$infoCustomer["PLANO_ESCOLHIDO"]["operadoraID"]]["nome"]." - ".$infoCustomer["PLANO_ESCOLHIDO"]["NAME"]."<br><strong>COD.:</strong> ".$infoCustomer["PLANO_ESCOLHIDO"]["PROPERTY_130"]["value"]; ?>
									</li>
								  </ul>
								</div>
							  </div>
                  ...
                  <li class="list-group-item"><strong>Declaracão de Saúde:</strong> <?php echo $status_ds; ?></li>
