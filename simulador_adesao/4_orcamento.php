                            ...
                            <p class="texto1"><strong>Resumo do Plano Escolhido:</strong></p>
                              <fieldset>	
                                <div class="form-card" id="planos2">
                                  ...
                                  <br>
                                  <p class="texto1"></p>
                                  <p class="texto1-left-dep"><strong>Titular + <strong><span class="qtDep">0</span> </strong>Beneficiário(s).</p>
                                  <p class="texto1"></p>
                                </div> 
                                        ...
                                        <form id="msform">
                                                   ...
                                                   <div  style="width: 100%;margin-left: 20px;">
                                                      <div  class="form-card-dep" id="planos2">
                                                        ...
                                                        <p class="texto"><strong>ORÇAMENTO</strong></p>
                                                        ...
                                                        <p class="texto1-central"><strong>Titular + <strong><span class="qtDep">0</span> </strong>Beneficiário(s).</p>
                                                        <p class="texto1-central"></p>                                    
